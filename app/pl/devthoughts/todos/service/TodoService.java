...
public class TodoService {
    ...
    public Try<TodoItem> updateItem(String id, TodoItemRequest request) {
        return repository.updateItem(id, request.getName(), request.getDueDate())
    ...
    public Try<TodoItem> done(String id) {
        return repository.finishItem(new TodoItemId(id))
    ...
    public Try<TodoItem> reopen(String id) {
        return repository.reopenItem(new TodoItemId(id))
